...
export const IS_QUIET_REQUESTED = process.env.NX_GENERATE_QUIET === 'true' ?? Boolean(process.env.NX_GENERATE_QUIET);
export const IS_VERBOSE_REQUESTED = process.env.NX_VERBOSE_LOGGING === 'true' ?? Boolean(process.env.NX_VERBOSE_LOGGING);
